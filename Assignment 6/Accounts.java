...
double balance;
String accountNumber, accountHoldersName, address; 
 Accounts(double bal, String an, String name, String add) {
...
SavingsAccount(double bal, String an, String name, String add, double rate) { 
 super(bal, an, name, add);
 rateOfInterest = rate;
}
...
void calculateAmount() {
 double amt = (balance + balance * rateOfInterest / 100.0); 
